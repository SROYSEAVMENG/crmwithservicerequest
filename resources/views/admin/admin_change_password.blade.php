        ...
        <div class="card rounded" style="border: none;">
          <div class="card-body" style="background-color: aliceblue; border:none">
            ...
            <div class="mt-3">
              ...
              <p class="text-muted" style="color: black;">{{$profileData->address}}</p>
            </div>
      ...
      <div class="col-md-8 col-xl-8 middle-wrapper">
        <div class="row">
            <div class="card" style="background-color: aliceblue; border:none">
                <div class="card-body">
                    <h6 class="card-title" style="color: black;">Admin Change Password</h6>

                        <form method="POST" action="{{ route('admin.update.password')}}" class="forms-sample" enctype="multipart/form-data">
                          @csrf
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Old Password</label>
                                <input type="password" name="old_password" class="form-control @error('old_password') is-invalid @enderror" id="old_password" style="background-color: aliceblue; color:black;">
                                @error('old_password')
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">New Password</label>
                                <input type="password" name="new_password" class="form-control @error('new_password') is-invalid @enderror" id="new_password" style="background-color: aliceblue;color:black;">
                                @error('new_password')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
