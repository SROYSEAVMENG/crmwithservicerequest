                      ...
                      <h6 class="card-title" style="color: black;">Account and Contact Info</h6>
                          ...
                          <form id="myForm" method="POST" action="" class="forms-sample" >
                            ...
                            <div  class="row" >
                                <div class="col-sm-6">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Engineer <span>*</span></label>
                                    <input type="text" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Max Re Allocation Date <span>*</span></label>
                                        <input type="date" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                </div>
                            </div>

                            <h6 class="card-title" style="color: black;">Description and Detail Info</h6>
                            ...
                            <div  class="row" >
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-4" >
                                    <label  class="form-label" style="color: gray;">Service Code <span>*</span></label>
                                ...
                                <div class="col-sm-4">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Remarks <span>*</span></label>
                                    <input type="text" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                </div>
                                </div>
                            </div>

                            <h6 class="card-title" style="color: black;">Action Info</h6>

                            <div  class="row" >
                                <div class="col-sm-3">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Region No <span>*</span></label>
                                    <input type="number" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                    <label  class="form-label" style="color: gray;">Activity Type <span>*</span></label>
                                        <select style="color: black;background-color:aliceblue"  class="js-example-basic-single form-select select2-hidden-accessible" name="call_type" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" required>
                                          <option value="Under Processing" data-select2-id="3">Under Processing</option>
                                          <option value="Finished" data-select2-id="13">Finished</option>
                                      </select>
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Actual Start Dt <span>*</span></label>
                                        <input type="date" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                    </div>
                                <div class="col-sm-3">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Arrival Date <span>*</span></label>
                                    <input type="date" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                </div>
                                </div>
                            </div>
                            ...
                            <div  class="row" >
                                <div class="col-sm-3">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Repair Start Dt <span>*</span></label>
                                    <input type="date" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Actual Comp Dt <span>*</span></label>
                                        <input type="date" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Repair Hours <span>*</span></label>
                                        <input type="date" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                    </div>
                                <div class="col-sm-3">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Wait Hours <span>*</span></label>
                                    <input type="time" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                </div>
                                </div>
                            </div>
                            ...
                            <div  class="row" >
                                <div class="col-sm-6">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Part Wait Hours <span>*</span></label>
                                        <input type="time" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                    </div>
                                <div class="col-sm-6">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Travel Hours <span>*</span></label>
                                    <input type="time" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                </div>
                                </div>
                            </div>
