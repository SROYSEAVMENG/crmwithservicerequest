        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
          <div class="row">
              <div class="card" style="background-color: aliceblue;border:none" >
                  <div class="card-body">
                      <h6 class="card-title" style="color: black;">Dispatch Information</h6>
                          ...
                          <form id="myForm" method="POST" action="" class="forms-sample" >
                            ...
                            <div  class="row" >
                                <div class="col-sm-3">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Docket No <span>*</span></label>
                                ...
                                <div class="col-sm-3">
                                  <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Bank Docket No <span>*</span></label>
                                    <input type="number" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                            ...
                            <div  class="row" >
                                ...
                                <div class="col-sm-3">
                                  <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Bank <span>*</span></label>
                                    <input type="text" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                            ...
                            <div  class="row" >
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Call Type <span>*</span></label>
                                        <input type="text" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Sub Call Type <span>*</span></label>
                                        <input type="text" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                    </div>
                            </div>
                            <div  class="row" >
                                <div class="col-sm-4">
                                <div class="mb-4" >
                                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Region <span>*</span></label>
                                    <input type="text" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Location <span>*</span></label>
                                        <input type="text" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div  class="row" >
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Dispatch Date <span>*</span></label>
                                        <input type="date" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                    <label  class="form-label" style="color: gray;">Engineer <span>*</span></label>
                                    ...
                                    <div class="col-sm-3">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Mobile <span>*</span></label>
                                        <input type="text" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                    </div>
