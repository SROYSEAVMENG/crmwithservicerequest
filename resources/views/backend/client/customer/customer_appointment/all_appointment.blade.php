...
<div class="card"  style="background-color: aliceblue; border:none;">
  <div class="card-body">
    <h6 class="card-title" style="color: black;">Appointment All</h6>
        ...
        <div class="modal-body">
            <form id="myForm" method="POST" action="{{ route('store.appointments')}}" class="forms-sample" >
                ...
                <div class="mb-3 form-group" >
                    ...
                    <input type="date" name="meeting_date" class="form-control" style="color: black;background-color:aliceblue" required>
                </div>
                <div class="mb-3 form-group" >
                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Person Name <span>*</span></label>
                    <input type="name" name="customer_name" class="form-control" style="color: black;background-color:aliceblue" required>
                </div>
                <div class="mb-3 form-group" >
                    <label for="exampleInputEmail1" class="form-label" style="color: gray;">Email <span>*</span></label>
                    <input type="email" name="customer_email" class="form-control" style="color: black;background-color:aliceblue" required>
                </div>
                <div class="mb-3 form-group" >
                ...
                <div class="mb-3 form-group" >
                    <label for="exampleInputEmail1" class="form-label" style="color: gray;" >Meeting By <span>*</span></label>
