                        ...
                        <form id="myForm" method="POST" action="{{ route('update.services',$services->id)}}" class="forms-sample" >
                          @csrf
                            <div class="mb-3 form-group" >
                                ...
                                <input type="text" style="background-color: aliceblue; color:black" name="name" class="form-control" value="{{ $services->name }}" required>
                            </div>
                            <div class="mb-3 form-group" >
                                <label for="exampleInputEmail1" class="form-label" style="color: gray;">Service Description <span>*</span></label>
                                <input type="text" style="background-color: aliceblue; color:black" name="description" class="form-control" value="{{ $services->description }}" required>
                            </div>
